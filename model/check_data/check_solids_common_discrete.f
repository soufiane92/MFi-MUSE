...
! Check for valid neighbor search option.
 ...
 2001 FORMAT('Error 2001:Invalid DES_NEIGHBOR_SEARCH method: ',I2,1X,A)
...
! Check the output file format
 ...
 2010 FORMAT('Error 2010:Invalid DES_OUTPUT_TYPE: ',A)
...
! Check for valid integration method
 ...
 2020 FORMAT('Error 2020:Invalid DES_INGT_METHOD: ',A)
...
! Notify that interpolation is not support for thermo variables
 ...
 2000 FORMAT('Error 2000: The selected interpolation scheme (',A,     &
...
! Notify that interpolation is not support for thermo variables
 ...
 2000 FORMAT('WARNING 2000: The selected interpolation scheme (',A,      &
         ') is not supported by the DES Species equation implementation.')
...
! Check dimension. This is redundant with check_data_03.
 ...
 1200 FORMAT('Error 1200: Illegal geometry for DEM/MPPIC. 2D ',        &
         'simulations are',/'restricted to the XY plane.')
...
! Cannot use interpolation when no scheme is selected.
 ...
 2000 FORMAT('Error 2000: Invalid DES_INTERP_SCHEME: ',A)
