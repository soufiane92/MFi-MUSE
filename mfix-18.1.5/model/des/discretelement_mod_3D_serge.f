...
! Eulerian grid weight
      ...
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: PN, VM_N, DPN, PNM, DPNM
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: PT, VM_T, DPT, PTM, DPTM 
      
      LOGICAL, DIMENSION(:), ALLOCATABLE :: ACTIVE


      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: VEL_ANALYTIC
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: POS_ANALYTIC
