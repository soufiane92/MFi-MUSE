...
MODULE DES_ALLOCATE
  ...
  PUBLIC:: DES_ALLOCATE_ARRAYS, ADD_PAIR, ADD_PAIR_ME, ADD_PAIR_AS, PARTICLE_GROW, PARTICLE_GROW_ME, PARTICLE_GROW_AS, ALLOCATE_DEM_MI
...
! with some factor.
      MAX_PIP = merge(0, 100*PARTICLES/numPEs, PARTICLES==UNDEFINED_I)
...
! ===================================== !
      ...
      Allocate(  PNM  (30*MAX_PIP) ) !3D
      Allocate(  DPNM  (30*MAX_PIP) ) !3D

      
      Allocate(  PT   (30*MAX_PIP , 3) ) ! FROTTEMENT 3D
      Allocate(  DPT  (30*MAX_PIP , 3) ) ! FROTTEMENT 3D
      Allocate(  VM_T (30*MAX_PIP , 3) ) ! FROTTEMENT 3D
      Allocate(  PTM  (30*MAX_PIP , 3) ) ! FROTTEMENT 3D
      Allocate(  DPTM (30*MAX_PIP , 3) ) ! FROTTEMENT 3D
            
      
      Allocate(  ACTIVE (30*MAX_PIP) )

      ALLOCATE (  VEL_ANALYTIC (MAX_PIP,DIMN) )
      ALLOCATE (  POS_ANALYTIC (MAX_PIP,DIMN) )
! ==================================== !
