...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
      ...
      SUBROUTINE DES_TIME_STEP(NN)
        ...
        PRINT*,"1 ==> ",DES_USR_VAR(AS_OLD_X,1),DES_USR_VAR(AS_NEW_U,1)
...
! ------------------------------------------------------------------------------------------------------------- !
              ...
              DO CC = CC_START, CC_END-1
                 ...
                 IF ((PARTICLE_STATE(P) * PARTICLE_STATE(I) == 1)) THEN
                    ...
                    IF (IGLOBAL_ID(P) .NE. IGLOBAL_ID(I)) THEN
                       ...
                       PRINT*,"AVANT ",DES_USR_VAR(AS_NEW_U,P)
                       ...
                       END IF
                       PRINT*,"APRES: ",DES_USR_VAR(AS_NEW_U,P)
        ...
        PRINT*,"2 ==> ",DES_USR_VAR(AS_NEW_X,1),DES_USR_VAR(AS_NEW_U,1)
